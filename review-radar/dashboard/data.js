...
(function () {
  ...
  var I18N = {
    en: {
      ...
      user_name:"The Outliers", user_role:"Product Owner",
      s1_eyebrow:"Set up monitoring",
      s1_title:"Monitor any app's reviews", s1_subtitle:"Search for an app to start tracking reviews, sentiment and action items — refreshed automatically every hour.",
      ...
      available:"Available Apps", available_sub:"Already crawled — open instantly",
      last_updated:"Updated", total_reviews:"reviews", open_dashboard:"Open dashboard",
      scraping_title:"Currently scraping", scraping_sub:"Crawl in progress — tap to view status", status_scraping:"Scraping", view_status:"View status", toast_scrape_done:"Scrape complete",
    ...
    vi: {
      ...
      s1_title:"Giám sát đánh giá của mọi ứng dụng", s1_subtitle:"Tìm một ứng dụng để bắt đầu theo dõi đánh giá, cảm xúc và việc cần xử lý — tự động làm mới mỗi giờ.",
      ...
      available:"Ứng dụng có sẵn", available_sub:"Đã thu thập — mở ngay",
      last_updated:"Cập nhật", total_reviews:"đánh giá", open_dashboard:"Mở dashboard",
      scraping_title:"Đang thu thập", scraping_sub:"Đang thu thập dữ liệu — bấm để xem trạng thái", status_scraping:"Đang thu thập", view_status:"Xem trạng thái", toast_scrape_done:"Đã thu thập xong",
