...
(function () {
  ...
  var I18N = {
    en: {
      ...
      s1_title:"Monitor store reviews without promising same-day completeness", s1_subtitle:"Search for an app to track reviews, sentiment and action items. Public store sources often publish with a one-day or longer delay, so snapshots are treated as daily intelligence.",
      desktop_notice:"Works best on a desktop browser.",
      source_window_prefix:"Typical source coverage through",
      s1_placeholder:"Enter app name to monitor…", s1_find:"Find App",
      review_count_label:"Number of reviews to collect", review_count_note:"The more reviews you pick, the longer the first crawl takes. Store freshness may lag by 1+ day.",
      suggested:"Suggested Matches", suggested_sub:"Ranked by name similarity",
      similarity:"match", confirm:"Confirm", confirmed:"Confirmed",
      available:"Available Apps", available_sub:"Daily snapshots — open instantly", available_search_placeholder:"Search available apps…", available_no_results:"No matching apps", available_no_results_sub:"Try another app name, publisher, platform, or app ID.", clear_search:"Clear search",
      last_updated:"Snapshot updated", total_reviews:"reviews", open_dashboard:"Open dashboard", start_crawl:"Collect reviews", hourly_on:"Refresh: on", hourly_off:"Refresh: off", hourly_disabled_short:"Off", hourly_admin_contact:"Store review feeds can lag by 1+ day; contact admin to change refresh.",
      scraping_title:"Collecting snapshot", scraping_sub:"Store collection in progress — tap to view status", status_scraping:"Collecting", status_queued:"Waiting", queue_title:"Collection Queue", queue_sub:"Apps are processed one at a time to avoid rate limits. Waiting apps start automatically in order.", queue_position:"Queue position", queue_next:"runs after the app ahead finishes", queue_starting:"Preparing to start", view_status:"View status", toast_scrape_done:"Snapshot updated", toast_crawled:"Fetched", toast_classified:"classified", toast_new_reviews:"new reviews", toast_no_new_reviews:"no new store reviews to classify", toast_no_reviews_fetched:"No new store reviews were available", toast_crawl_fallback:"No new store reviews fetched; refreshed from saved data", toast_crawl_error:"Collection ended with an error",
      ...
      schedule_title:"Refresh schedule", schedule_sub:"Choose how often we refresh this app's store snapshot.",
    ...
    vi: {
      ...
      s1_title:"Giám sát đánh giá store theo snapshot hằng ngày", s1_subtitle:"Tìm một ứng dụng để theo dõi đánh giá, cảm xúc và việc cần xử lý. Nguồn public từ store thường trễ ít nhất một ngày, nên dashboard không cam kết đủ dữ liệu trong ngày.",
      desktop_notice:"Hoạt động tốt nhất trên trình duyệt desktop.",
      source_window_prefix:"Dữ liệu nguồn thường tới",
      s1_placeholder:"Nhập tên ứng dụng cần giám sát…", s1_find:"Tìm ứng dụng",
      review_count_label:"Số review muốn thu thập", review_count_note:"Chọn càng nhiều review thì lần thu thập đầu sẽ càng lâu. Dữ liệu store có thể trễ 1+ ngày.",
      suggested:"Kết quả phù hợp", suggested_sub:"Xếp hạng theo độ tương đồng tên",
      similarity:"khớp", confirm:"Chọn", confirmed:"Đã chọn",
      available:"Ứng dụng có sẵn", available_sub:"Snapshot hằng ngày — mở ngay", available_search_placeholder:"Tìm trong ứng dụng có sẵn…", available_no_results:"Không tìm thấy ứng dụng phù hợp", available_no_results_sub:"Thử tên app, nhà phát hành, nền tảng hoặc app ID khác.", clear_search:"Xóa tìm kiếm",
      last_updated:"Snapshot cập nhật", total_reviews:"đánh giá", open_dashboard:"Mở dashboard", start_crawl:"Thu thập đánh giá", hourly_on:"Refresh: bật", hourly_off:"Refresh: tắt", hourly_disabled_short:"Tắt", hourly_admin_contact:"Feed đánh giá từ store có thể trễ 1+ ngày; liên hệ admin để đổi refresh.",
      scraping_title:"Đang thu thập snapshot", scraping_sub:"Đang thu thập từ store — bấm để xem trạng thái", status_scraping:"Đang thu thập", status_queued:"Đang chờ", queue_title:"Hàng đợi thu thập", queue_sub:"Các app được xử lý lần lượt để tránh rate limit. App đang chờ sẽ tự chạy theo thứ tự.", queue_position:"Vị trí hàng đợi", queue_next:"chạy sau app phía trước", queue_starting:"Đang chuẩn bị chạy", view_status:"Xem trạng thái", toast_scrape_done:"Đã cập nhật snapshot", toast_crawled:"Đã lấy được", toast_classified:"phân loại", toast_new_reviews:"đánh giá mới", toast_no_new_reviews:"không có đánh giá mới từ store để phân loại", toast_no_reviews_fetched:"Store chưa có đánh giá mới", toast_crawl_fallback:"Không lấy được đánh giá mới, đã cập nhật từ dữ liệu đã lưu", toast_crawl_error:"Thu thập kết thúc với lỗi",
      ...
      schedule_title:"Lịch refresh", schedule_sub:"Chọn tần suất làm mới snapshot store cho ứng dụng này.",
