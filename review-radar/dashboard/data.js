...
(function () {
  ...
  var I18N = {
    en: {
      ...
      s1_title:"Monitor any app's reviews", s1_subtitle:"Search for an app to start tracking reviews, sentiment and action items. Hourly refreshes read the latest 100 reviews by default; admins can adjust this later.",
      ...
      last_updated:"Updated", total_reviews:"reviews", open_dashboard:"Open dashboard", start_crawl:"Collect reviews",
      ...
      notify:"Notify me when ready", back_apps:"Back to available apps", almost:"Almost there…", skip_now:"Open dashboard now", skip_hint:"Classification keeps running in the background — refresh later for the rest.",
    ...
    vi: {
      ...
      s1_title:"Giám sát đánh giá của mọi ứng dụng", s1_subtitle:"Tìm một ứng dụng để bắt đầu theo dõi đánh giá, cảm xúc và việc cần xử lý. Mỗi giờ mặc định lấy 100 review mới nhất; admin có thể điều chỉnh sau.",
      ...
      last_updated:"Cập nhật", total_reviews:"đánh giá", open_dashboard:"Mở dashboard", start_crawl:"Thu thập đánh giá",
      ...
      notify:"Báo tôi khi xong", back_apps:"Về danh sách ứng dụng", almost:"Sắp xong…", skip_now:"Vào dashboard ngay", skip_hint:"Phân loại vẫn tiếp tục chạy ở chế độ nền — tải lại sau để xem phần còn lại.",
