...
(function () {
  ...
  var I18N = {
    en: {
      ...
      s1_eyebrow:"Set up monitoring",
      s1_title:"Monitor any app's reviews", s1_subtitle:"Search for an app to start tracking reviews, sentiment and action items. Hourly refreshes only run for enabled apps and read the latest 100 reviews by default; admins can adjust this later.",
      desktop_notice:"Works best on a desktop browser.",
      s1_placeholder:"Enter app name to monitor…", s1_find:"Find App",
      review_count_label:"Number of reviews to scrape", review_count_note:"The more reviews you pick, the longer the first crawl takes.",
      suggested:"Suggested Matches", suggested_sub:"Ranked by name similarity",
      similarity:"match", confirm:"Confirm", confirmed:"Confirmed",
      available:"Available Apps", available_sub:"Already crawled — open instantly", available_search_placeholder:"Search available apps…", available_no_results:"No matching apps", available_no_results_sub:"Try another app name, publisher, platform, or app ID.", clear_search:"Clear search",
      last_updated:"Updated", total_reviews:"reviews", open_dashboard:"Open dashboard", start_crawl:"Collect reviews", hourly_on:"Hourly: on", hourly_off:"Hourly: off", hourly_disabled_short:"Off", hourly_admin_contact:"Please contact admin to enable/disable refresh.",
      scraping_title:"Currently scraping", scraping_sub:"Crawl in progress — tap to view status", status_scraping:"Scraping", status_queued:"Waiting", queue_title:"Crawl Queue", queue_sub:"Apps are processed one at a time to avoid rate limits. Waiting apps start automatically in order.", queue_position:"Queue position", queue_next:"runs after the app ahead finishes", queue_starting:"Preparing to start", view_status:"View status", toast_scrape_done:"Update complete", toast_crawled:"Fetched", toast_classified:"classified", toast_new_reviews:"new reviews", toast_no_new_reviews:"no new reviews to classify", toast_no_reviews_fetched:"No live reviews were fetched", toast_crawl_fallback:"No live reviews fetched; refreshed from saved data", toast_crawl_error:"Crawl ended with an error",
      health_healthy:"Healthy", health_warning:"Warning", health_critical:"Critical",
      empty_title:"Start by searching an app", empty_sub:"Type an app name above and we'll find the closest matches across the App Store and Google Play.",
      searching:"Searching app stores…",
      min_ago:"m ago", hour_ago:"h ago",
      s2_eyebrow:"Preparing dashboard",
      s2_title:"Setting up monitoring for", s2_note:"Crawling a new app for the first time can take a few minutes. You can leave this page — we'll keep working in the background.",
      step_confirmed:"App confirmed", step_confirmed_d:"Source verified on App Store",
      step_crawling:"Crawling reviews", step_crawling_d:"Collecting reviews across all versions",
      ...
      notify:"Notify me when ready", back_apps:"Back to available apps", almost:"Almost there…", skip_now:"Open dashboard now", skip_hint:"Classification keeps running in the background — refresh later for the rest.", open_existing_dashboard:"Open existing dashboard", queued_existing_data:"Existing dashboard data is still available while this refresh waits.", existing_dashboard_hint:"This refresh continues in the background; the dashboard will update after it finishes.",
      ...
      opt_section:"Options",
      opt_notify:"Email me when critical bugs appear", opt_notify_d:"Get alerted within minutes of a spike.",
      opt_pause:"Pause crawling on weekends", opt_pause_d:"Saves crawl quota when traffic is low.",
      cancel:"Cancel", save_changes:"Save changes", schedule_saved:"Crawl schedule updated",
      filter_platform:"Platform", filter_category:"Category", filter_priority:"Priority", filter_sentiment:"Sentiment", all:"All",
      kpi_total:"Total Reviews", kpi_today:"Reviews Today", kpi_critical:"Critical Bugs To Fix", kpi_fixed:"Bugs Fixed", kpi_pending:"Pending Action Items", kpi_health:"Review Health Score",
      sub_all_time:"All time", sub_vs_yesterday:"vs yesterday", sub_need_fix:"Need urgent fix", sub_last_30d:"Last 30 days", sub_action_items:"Awaiting triage", sub_out_of_100:"Sentiment-weighted",
      ...
      r7:"7D", r30:"30D", r90:"90D", legend_reviews:"Reviews / day", legend_health:"Health score",
    ...
    vi: {
      ...
      user_name:"The Outlier", user_role:"Product Owner",
      s1_eyebrow:"Thiết lập giám sát",
      s1_title:"Giám sát đánh giá của mọi ứng dụng", s1_subtitle:"Tìm một ứng dụng để bắt đầu theo dõi đánh giá, cảm xúc và việc cần xử lý. Mỗi giờ chỉ làm mới các app đang bật Hourly và mặc định lấy 100 review mới nhất; admin có thể điều chỉnh sau.",
      desktop_notice:"Hoạt động tốt nhất trên trình duyệt desktop.",
      s1_placeholder:"Nhập tên ứng dụng cần giám sát…", s1_find:"Tìm ứng dụng",
      review_count_label:"Số review muốn thu thập", review_count_note:"Chọn càng nhiều review thì lần thu thập đầu sẽ càng lâu.",
      suggested:"Kết quả phù hợp", suggested_sub:"Xếp hạng theo độ tương đồng tên",
      similarity:"khớp", confirm:"Chọn", confirmed:"Đã chọn",
      available:"Ứng dụng có sẵn", available_sub:"Đã thu thập — mở ngay", available_search_placeholder:"Tìm trong ứng dụng có sẵn…", available_no_results:"Không tìm thấy ứng dụng phù hợp", available_no_results_sub:"Thử tên app, nhà phát hành, nền tảng hoặc app ID khác.", clear_search:"Xóa tìm kiếm",
      last_updated:"Cập nhật", total_reviews:"đánh giá", open_dashboard:"Mở dashboard", start_crawl:"Thu thập đánh giá", hourly_on:"Hourly: bật", hourly_off:"Hourly: tắt", hourly_disabled_short:"Tắt", hourly_admin_contact:"Vui lòng liên hệ admin để được bật/tắt refresh",
      scraping_title:"Đang thu thập", scraping_sub:"Đang thu thập dữ liệu — bấm để xem trạng thái", status_scraping:"Đang thu thập", status_queued:"Đang chờ", queue_title:"Hàng đợi thu thập", queue_sub:"Các app được xử lý lần lượt để tránh rate limit. App đang chờ sẽ tự chạy theo thứ tự.", queue_position:"Vị trí hàng đợi", queue_next:"chạy sau app phía trước", queue_starting:"Đang chuẩn bị chạy", view_status:"Xem trạng thái", toast_scrape_done:"Đã cập nhật xong", toast_crawled:"Đã lấy được", toast_classified:"phân loại", toast_new_reviews:"đánh giá mới", toast_no_new_reviews:"không có đánh giá mới để phân loại", toast_no_reviews_fetched:"Không lấy được đánh giá mới từ store", toast_crawl_fallback:"Không lấy được đánh giá mới, đã cập nhật từ dữ liệu đã lưu", toast_crawl_error:"Crawl kết thúc với lỗi",
      health_healthy:"Tốt", health_warning:"Cảnh báo", health_critical:"Nghiêm trọng",
      empty_title:"Bắt đầu bằng cách tìm một ứng dụng", empty_sub:"Nhập tên ứng dụng phía trên, chúng tôi sẽ tìm các kết quả gần nhất trên App Store và Google Play.",
      searching:"Đang tìm trên kho ứng dụng…",
      min_ago:" phút trước", hour_ago:" giờ trước",
      s2_eyebrow:"Đang chuẩn bị dashboard",
      s2_title:"Đang thiết lập giám sát cho", s2_note:"Thu thập một ứng dụng mới lần đầu có thể mất vài phút. Bạn có thể rời trang — chúng tôi vẫn xử lý ở chế độ nền.",
      step_confirmed:"Đã xác nhận ứng dụng", step_confirmed_d:"Đã xác minh nguồn trên App Store",
      step_crawling:"Đang thu thập đánh giá", step_crawling_d:"Thu thập đánh giá trên mọi phiên bản",
      ...
      opt_notify:"Gửi email khi có bug nghiêm trọng", opt_notify_d:"Nhận cảnh báo trong vài phút khi có đột biến.",
      opt_pause:"Tạm dừng thu thập vào cuối tuần", opt_pause_d:"Tiết kiệm hạn mức khi lưu lượng thấp.",
      cancel:"Hủy", save_changes:"Lưu thay đổi", schedule_saved:"Đã cập nhật lịch thu thập",
      filter_platform:"Nền tảng", filter_category:"Danh mục", filter_priority:"Ưu tiên", filter_sentiment:"Cảm xúc", all:"Tất cả",
      kpi_total:"Tổng đánh giá", kpi_today:"Đánh giá hôm nay", kpi_critical:"Bug nghiêm trọng cần sửa", kpi_fixed:"Bug đã sửa", kpi_pending:"Việc đang chờ xử lý", kpi_health:"Điểm sức khỏe đánh giá",
      sub_all_time:"Toàn thời gian", sub_vs_yesterday:"so với hôm qua", sub_need_fix:"Cần sửa gấp", sub_last_30d:"30 ngày qua", sub_action_items:"Đang chờ phân loại", sub_out_of_100:"Tính theo cảm xúc",
      ...
      r7:"7N", r30:"30N", r90:"90N", legend_reviews:"Đánh giá / ngày", legend_health:"Điểm sức khỏe",
