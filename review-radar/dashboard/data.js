...
(function () {
  ...
  var I18N = {
    en: {
      ...
      loading_dashboard:"Loading dashboard…", back_apps:"Back to available apps", cancel_crawl:"Stop & keep results", cancelling:"Stopping…", almost:"Almost there…", skip_now:"Open dashboard now", skip_hint:"Classification keeps running in the background — refresh later for the rest.", open_existing_dashboard:"Open existing dashboard", queued_existing_data:"Existing dashboard data is still available while this refresh waits.", existing_dashboard_hint:"This refresh continues in the background; the dashboard will update after it finishes.",
      ...
      kpi_health_formula:"Formula: 70 + 50 x (positive - 0.5 x (complaints + bugs)) / classified reviews, capped from 0 to 100.",
      ...
      leaderboard:"Overall ranking", best:"Best", metric:"Metric", sentiment_split:"Sentiment split", sentiment_sub:"Positive, neutral, and negative review mix", rating_dist:"Rating distribution", rating_sub:"Share of reviews by star rating", health_trend:"Health trend (14d)", cat_compare:"Category mix", at_a_glance:"At a glance",
    ...
    vi: {
      ...
      kpi_health_formula:"Công thức: 70 + 50 x (tích cực - 0.5 x (phàn nàn + bug)) / số review đã phân loại, giới hạn từ 0 đến 100.",
      ...
      leaderboard:"Xếp hạng tổng thể", best:"Tốt nhất", metric:"Chỉ số", sentiment_split:"Tỉ lệ cảm xúc", sentiment_sub:"Cơ cấu tích cực, trung lập và tiêu cực", rating_dist:"Phân bố sao", rating_sub:"Tỉ trọng đánh giá theo số sao", health_trend:"Xu hướng sức khỏe (14n)", cat_compare:"Cơ cấu danh mục", at_a_glance:"Tổng quan nhanh",
